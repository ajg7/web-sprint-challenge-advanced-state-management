...
1. What problem does the context API help solve?
  ...
  Context API allows you to share state down a component tree without prop drilling

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

  store contains all state in the app, and can be accessed throughout the app. Reducers will hold and create copies of initial state and then update it. Actions send data to the store which is used in reducers.

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

  Component state is state that is managed inside a component, which is good when you need to use state within the component. Application state is state that can be accessed throughout the app, and is best for data that needs to accessed in many components like store

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

  Redux-Thunk is middleware that allows you to return a dispatch function

5. What is your favorite state management system you've learned and this sprint? Please explain why!

  Redux because I like having all my state accessible to every component in the app.
